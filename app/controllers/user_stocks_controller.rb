class UserStocksController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_stock.save
       format.html { redirect_to my_finance_path, notice: "#{@user_stock.stock.ticker} stock was successfully added"}
  ...
  def destroy
    @user_stock.destroy
    respond_to do |format|
      format.html { redirect_to my_finance_path, notice: 'Stock was successfully removed from your tracker.' }
